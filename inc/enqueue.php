...
if ( ! function_exists( 'citadel_scripts' ) ) {
	...
	function citadel_scripts() {
		...
		$css_version = $theme_version . '.' . filemtime( get_template_directory() . '/stylesheets/style.css' );
		wp_enqueue_style( 'citadel-styles', get_template_directory_uri() . '/stylesheets/style.css', array(), $css_version );
